const allLogins = ["qwerty", "goddess", "777macaroni", "123user", "zxcvbnm"];
let login;
...
const addLogin = function(allLogins, login) {
    if (login === null) {
        alert(`Отмена ввода логина`);
        return console.log(`canceled`);
    } else if (isLoginValid(login) === false) {
        alert(`Ошибка! Логин должен быть от 4 до 16 символов`);
        return console.log(`login is too short or too long`);
        ...
        return console.log(`login added successfully`);
    }
};
